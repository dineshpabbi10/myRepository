...
public class MerchantRecoverPass extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
        ResultSet rs=DBLoader.executeQuery("select * from merchant_info where email='" + email + "' and mobilenumber= '" + mobilenumber + "'");
