...
public class CustomerForgotPassword extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String mobilenumber = (String) session.getAttribute("usermobile");

        try {
            ResultSet rs = DBLoader.executeQuery("select * from customers where email='" + customeremail + "' and mobile= '" + mobilenumber + "'");
