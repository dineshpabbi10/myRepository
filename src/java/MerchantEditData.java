...
public class MerchantEditData extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           // Part proof = request.getPart("idproof");
            ...
            ResultSet rs = DBLoader.executeQuery("select * from merchant_info  where email='" + email + "'");
            ...
            if (rs.next()) {
                ...
                rs.updateString("photo", "uploads/" + photoname);
            ...
            Logger.getLogger(MerchantEditData.class.getName()).log(Level.SEVERE, null, ex);
